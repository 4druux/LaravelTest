    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0 ">
        <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
            @forelse ($posts as  $post)
                ...
                @empty
                <p class="font-semibold text-center text-xl my-4">No post found!</p>
                <a href="/posts" class="font-medium text-xs text-blue-600 hover:underline">&laquo; Back to posts</a>
